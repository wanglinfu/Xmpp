...
import zz.itcast.mediaplayer11.view.VideoView;
...
public class VideoPlayerActivity extends BaseActivity {
    ...
    private final class OnVideoErrorListener implements OnErrorListener {
        ...
        public boolean onError(MediaPlayer mp, int what, int extra) {
            AlertDialog.Builder builder = new Builder(VideoPlayerActivity.this);
            builder.setTitle("提示");
    ...
    private final class OnVideoBufferingUpdateListener implements OnBufferingUpdateListener {
        ...
        public void onBufferingUpdate(MediaPlayer mp, int percent) {
            //更新seekbar的第二进度
            int buffer = percent*video_player_videoview.getDuration();
            logI("缓冲进度："+percent);
...
//        logI("当前时间："+System.currentTimeMillis());
    ...
    private void initProgressView() {
        ...
        int duration = video_player_videoview.getDuration();
        // 文本展示的需要是格式化后的时间
